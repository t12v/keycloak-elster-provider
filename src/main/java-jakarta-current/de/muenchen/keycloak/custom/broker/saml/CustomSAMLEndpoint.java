...
public class CustomSAMLEndpoint extends SAMLEndpoint {
    ...
    public Element decryptEncryptedID(EncryptedElementType encryptedID) throws ConfigurationException, IOException, TransformerException, ProcessingException {
        ...
        Element decryptedElement = XMLEncryptionUtil.decryptElementInDocument(tempDoc, asDecryptionKeyLocator(keys.getPrivateKey()));
    ...
    public static Element decryptAssertion(SAMLDocumentHolder holder, ResponseType responseType, PrivateKey privateKey) throws ParsingException, ProcessingException, ConfigurationException {
        ...
        Element decryptedDocumentElement = XMLEncryptionUtil.decryptElementInDocument(newDoc, asDecryptionKeyLocator(privateKey));
    ...
    private static XMLEncryptionUtil.DecryptionKeyLocator asDecryptionKeyLocator(PrivateKey privateKey) {
        return encryptedData -> Collections.singletonList(privateKey);
    }
